"""
Django settings for goc project.
...
SECRET_KEY = 'django-insecure-k_d#x07nax7b#)f_twngqi8-fpd3b18w$pc$=s_ie=0j*lo(-5'
...
WSGI_APPLICATION = 'goc.wsgi.application'
